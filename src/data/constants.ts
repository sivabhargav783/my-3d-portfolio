...
export const SKILLS: Record<SkillNames, Skill> = {
  [SkillNames.JS]: {
    ...
    name: "js",
    label: "SQL",
    shortDescription: "query queen serving structured tea ☕📊",
    color: "#38bdf8",
  ...
  [SkillNames.TS]: {
    ...
    label: "SonarQube",
    shortDescription:
      "code therapist, pointing out all the red flags 🚩🩺",
    color: "#007acc",
  ...
  [SkillNames.HTML]: {
    ...
    name: "html",
    label: "Terraform",
    shortDescription: "cloud Lego blocks but in code, bruh 🧱🌍",
    color: "#e34c26",
  ...
  [SkillNames.CSS]: {
    ...
    name: "css",
    label: "Python",
    shortDescription: "big brain energy in a chill syntax 🐍🧠",
    color: "#563d7c",
  ...
  [SkillNames.REACT]: {
    ...
    name: "react",
    label: "Hack Tools",
    shortDescription: `cyber ninjas’ secret weapon stash 🥷💻`,
    color: "#61dafb",
  ...
  [SkillNames.VUE]: {
    ...
    label: "Kubernetes",
    shortDescription:
      "ship captain for containers, smooth sailing ⛵📦",
    color: "#41b883",
  ...
  [SkillNames.NEXTJS]: {
    ...
    label: "Ansible",
    shortDescription:
      "automation vibes, no drama attached 🤖📦",
    color: "#fff",
  ...
  [SkillNames.TAILWIND]: {
    ...
    name: "tailwind",
    label: "Argo CD",
    shortDescription: "GitOps drip, shipping apps auto-magically 🚀✨",
    color: "#38bdf8",
  ...
  [SkillNames.NODEJS]: {
    ...
    name: "nodejs",
    label: "Docker Hub",
    shortDescription: "container flex central, pull up! 🛳️📦",
    color: "#6cc24a",
  ...
  [SkillNames.EXPRESS]: {
    ...
    name: "express",
    label: "Jenkins",
    shortDescription: "the OG pipeline butler, always on duty 🤵⚙️",
    color: "#fff",
  ...
  [SkillNames.POSTGRES]: {
    ...
    shortDescription: "infra origami folded with JSON/YAML 📜☁️",
    color: "#336791",
  ...
  [SkillNames.PRETTIER]: {
    ...
    shortDescription: "workflow wizardry straight from the repo 🪄📂",
    color: "#f7b93a",
  ...
  [SkillNames.NPM]: {
    ...
    shortDescription: "where devs cook quick hacks like 5-star chefs 🍳💻",
    color: "#fff",
  ...
  [SkillNames.FIREBASE]: {
    ...
    label: "Grafana",
    shortDescription:
      "dashboard drip giving data Picasso vibes 🎨📊",
    color: "#ffca28",
  ...
  [SkillNames.WORDPRESS]: {
    ...
    name: "wordpress",
    label: "Prometheus",
    shortDescription: "metrics god, watching everything ⚡📈",
    color: "#007acc",
