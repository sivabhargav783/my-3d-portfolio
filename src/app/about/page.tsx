...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "sivabhargav783@gmail",
    href: "mailto:sivabhargav783@gmail.com",
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/bachala-siva-bhargav-2936a2260/",
    content: "/sivabhargav",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/SivaBhargav7",
    content: "/sivabhargav",
      ...
      <div className="flex flex-col lg:flex-row gap-5">
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            Explore the portfolio of Siva Bhargav, an AWS Certified Solutions Architect and Cloud Practitioner with hands-on experience in Cloud Computing, DevOps, and Python Development. Skilled in deploying scalable applications, automating CI/CD pipelines, managing databases, and implementing highly available architectures on AWS. Strong problem-solving abilities, effective communication, and a team-oriented mindset to drive innovation and deliver results.
            </p>
            <p className="mb-10">
              When I&apos;m relaxing, you can find me [Your
